...
//     // ✅ After splash, check login session
//     Future.delayed(const Duration(seconds: 3), () async {
//       final loginController = Get.put(LoginController());

//       // Check if session is valid (15 min)
//       bool sessionValid = await loginController.isSessionValid();

//       if (sessionValid) {
//         // Session valid → go to Home/QR Screen
//         Get.offAll(() => const QrScanScreen());
//       } else {
