...
// //                   ),
// //
// //                   // Dark overlay outside scanning box
// //                   ColorFiltered(
...
class _QrScanScreenState extends State<QrScanScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double boxHeight = MediaQuery.of(context).size.height * 0.35; // taller
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              left: 10,
              child: IconButton(
                icon: const Icon(Icons.arrow_back, color: CustomColor.mainText, size: 25),
                onPressed: () => Get.back(),
              ),
            ),
